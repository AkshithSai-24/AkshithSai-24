...
export const Contact = () => {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    const apiKey = import.meta.env.VITE_MAILING_SERVICE_API_KEY;

    if (!apiKey) {
      toast({
        title: "Configuration Error",
        description: "Mailing API key is missing. Please check your .env file.",
        variant: "destructive",
      });
    ...
    try {
      const response = await fetch('https://qwertymailingservice.onrender.com/send-email', {
        ...
        body: JSON.stringify({
          to: ['akshithsai24@gmail.com'],
          subject: `Portfolio Contact: ${subject}`,
          html: `
            <div style="font-family: sans-serif; padding: 20px; color: #333;">
              <h2 style="color: #0ea5e9;">New Message from Portfolio</h2>
      ...
      console.error('Mailing Service Error:', error);
    } finally {
      setIsSubmitting(false);
    }
  };
        ...
        <div className="grid lg:grid-cols-2 gap-12 max-w-5xl mx-auto">
          ...
          >
            ...
            <div className="space-y-6">
              <a
                href="mailto:akshithsai24@gmail.com"
              ...
              >
                ...
                <div>
                  ...
                  <p className="font-medium group-hover:text-primary transition-colors">akshithsai24@gmail.com</p>
                </div>
              </a>

              <a
                href="tel:+919346514058"
                className="flex items-center gap-4 glass-card p-4 hover:border-primary/30 transition-all duration-300 group"
              >
                <div className="w-12 h-12 rounded-xl bg-primary/10 flex items-center justify-center group-hover:bg-primary/20 transition-colors">
                ...
                <div>
                  ...
                  <p className="font-medium group-hover:text-primary transition-colors">+91 9346514058</p>
                </div>
              </a>
            ...
            <div className="mt-8">
              ...
              <div className="flex gap-3">
                <a href="https://linkedin.com/in/kakshithsai" target="_blank" rel="noopener noreferrer" className="social-icon">
                  <Linkedin size={20} />
                </a>
                <a href="https://github.com/AkshithSai-24" target="_blank" rel="noopener noreferrer" className="social-icon">
                  <Github size={20} />
                </a>
                <a href="mailto:akshithsai24@gmail.com" className="social-icon">
                  <Mail size={20} />
                </a>
              </div>
            </div>
