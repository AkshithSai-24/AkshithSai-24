...
export const Hero = () => {
  ...
  const resumeUrl = "/AkshithSai_Resume.pdf";
        ...
        <div className="flex-1 flex flex-col items-center lg:items-start text-center lg:text-left">
          ...
          >
            ...
            <h1 className="font-display text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold mb-6">
              Akshith Sai <span className="gradient-text">Kondamadugu</span>
            </h1>
          </motion.div>
          ...
          >
            ...
            <br /><br />
            Computer Science Engineering graduate with hands-on experience in Machine Learning, Deep Learning, Generative AI, and Agentic AI systems. I specialize in building autonomous pipelines and deploying models on AWS and GCP.
          </motion.p>
