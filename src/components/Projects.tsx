...
const projects = [
  {
    ...
    live: 'https://dynamicbi.akshithsai.co.in',
    image: '/project-dynamicbi.png',
  },
  {
    title: 'Multimodal RAG',
    description: 'A full-stack Retrieval-Augmented Generation application that understands and answers questions about text, tables, images, slides, PDFs, web pages, and YouTube videos. Built with FastAPI, LangChain, ChromaDB, and NVIDIA NIM for embeddings and vision.',
    tags: ['FastAPI', 'LangChain', 'ChromaDB', 'NVIDIA NIM', 'React', 'RAG'],
    categories: ['🤖 Agentic AI'],
    github: 'https://github.com/AkshithSai-24/Multimodal-RAG',
    live: 'https://rag.akshithsai.co.in',
